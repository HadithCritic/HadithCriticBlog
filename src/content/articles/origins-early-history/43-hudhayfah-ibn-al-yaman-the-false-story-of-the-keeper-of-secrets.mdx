...
description: "There are narrations in the Hadith corpus that describe an event during the Prophet Muhammad’s expedition to Tabuk. As the Prophet dismounted to receive…"
date: 2025-03-14T21:06:43.000Z
category: "Origins & Early History"
tags: ["hadith","prophecy","religious_tradition","scholarship"]
thumbnail: "/images/blog_thumbnails/tn.43.webp"
---
...
export const hudhayfahNodes = [
  { id: 'hudhayfah', x: 200, y: 700, label: 'Ḥudhayfah\n(Direct attribution)', labelPos: 'left' },
  { id: 'urwah', x: 600, y: 700, label: 'ʿUrwah b. al-Zubayr\n("Balaghanā" - It reached us)', labelPos: 'right' },
  { id: 'zuhri', x: 400, y: 400, label: 'Ibn Shihāb al-Zuhrī', kind: 'cl', labelPos: 'right' },
  { id: 'mamar', x: 200, y: 200, label: 'Maʿmar b. Rāshid', labelPos: 'left' },
  { id: 'others', x: 600, y: 200, label: 'Other Transmitters', labelPos: 'right' },
  { id: 'collections', x: 400, y: 0, label: 'Hadith Collections', kind: 'collector', labelPos: 'above' }
];

export const hudhayfahEdges = [
  { from: 'hudhayfah', to: 'zuhri', kind: 'trunk' },
  { from: 'urwah', to: 'zuhri', kind: 'trunk' },
  { from: 'zuhri', to: 'mamar' },
  { from: 'zuhri', to: 'others' },
  { from: 'mamar', to: 'collections' },
  { from: 'others', to: 'collections' }
];
...
<IsnadDiagram
  width={800}
  height={800}
  nodes={hudhayfahNodes}
  edges={hudhayfahEdges}
  caption="The isnads tracing back to the Common Link: Ibn Shihāb al-Zuhrī."
/>
## Analysis
